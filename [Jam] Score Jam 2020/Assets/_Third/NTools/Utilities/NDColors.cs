...
public static class NDColors
{
    // From https://gist.github.com/LotteMakesStuff/f7ce43f11e545a151b95b5e87f76304c
    ...
    /// <summary>
    /// Random color from CS3 extended colors
    /// </sumary>
    public static Color RandomColor()
    {
        switch (Random.Range(0, 140))
        {
        ...
        throw new System.Exception("Randomized color does not exist...");
    }

    /// <summary>
    /// Returns a random color between min n max
    /// </summary>
    public static Color RandomColor(Color min, Color max, bool randomAlpha = false)
    {
        var randomizedColor = new Color()
        {
            r = UnityEngine.Random.Range(min.r, max.r),
            g = UnityEngine.Random.Range(min.g, max.g),
            b = UnityEngine.Random.Range(min.b, max.b),
            a = randomAlpha ? UnityEngine.Random.Range(min.a, max.a) : 1f
        };
